...
### Step 5: Invoke Haiku agents in waves
...
Task(
  ...
  subagent_type: "project-knowledge-base:haiku-batch-analysis",
  model: "haiku",
  tools: "Read, Write"
...
**Agent Used:**
- Agent: project-knowledge-base:haiku-batch-analysis
- Model: Haiku (default)
...
```json
{
  "files": [
    {
        "path": "plugins\\project-knowledge-base\\README.md",
        "size": 12403
    }
  ],
  "projectStats": {
