...
All notable changes to the documentation plugin documented here.
...
- managing-documentation skill for creating and maintaining high-quality project documentation
